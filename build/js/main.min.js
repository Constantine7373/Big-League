...
var loaderBtn = document.querySelector('.loader__continue');
var menuBtn = document.querySelector('.main-nav__menu-btn');
var mainNav = document.querySelector('.main-nav__list');
var mainIntro = document.querySelector('.main-intro'); // Работа с лоадером

var loaderClose = function loaderClose(e) {
  e.preventDefault();
...
menuBtn.addEventListener('click', function () {
  var expanded = menuBtn.getAttribute('aria-expanded') === 'true' || false;
